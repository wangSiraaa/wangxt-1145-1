...
public class DocumentCloseAction implements ICommonAction {
    ...
    public Object doAction(IRequest request) {
        ...
        try {
            ...
            if (pks != null && !pks.isEmpty()) {
                List<AggDocumentVO> results = new ArrayList<AggDocumentVO>();
                for (String pk : pks) {
                    AggDocumentVO result = service.closeDocument(pk);
                    if (result != null) {
                        results.add(result);
                    }
                }
            ...
            String pkDocument = null;
            if (obj instanceof Map) {
                Map params = (Map) obj;
                pkDocument = getParamValue(params, "pk_document");
            ...
            AggDocumentVO result = service.closeDocument(pkDocument);
